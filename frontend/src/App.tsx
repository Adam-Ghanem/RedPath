...
function ReferenceBoard() {
  return <div className="reference-board" role="img" aria-label="Observed RedPath exposure route through synthetic Active Directory evidence">
    <svg viewBox="0 0 1000 620" preserveAspectRatio="none"><path className="observed" d="M125 250 H290 L420 200 H635 L765 270 V410 H650 L505 500" /><path className="inferred" d="M125 250 L240 410 H420" /><path className="inferred" d="M125 250 L125 430 L505 500" />
