...
function AIReviewBadge() {
  return <span className="ai-review-badge" title="AI output is advisory and requires analyst verification">AI-generated — verify before acting</span>;
}

function ReferenceBoard() {
  return <div className="reference-board" role="img" aria-label="Observed RedPath exposure route through synthetic Active Directory evidence">
    <svg viewBox="0 0 1000 620" preserveAspectRatio="xMidYMid meet"><path className="observed" d="M135 250 H290 L425 200 H635 L765 270" /><path className="observed" d="M765 270 V410 H650 L505 500" /><path className="inferred" d="M135 250 L250 410 H425" /><path className="inferred" d="M135 250 V430 L505 500" />
      <g transform="translate(105 225)"><circle className="node-plate" cx="30" cy="25" r="29" /><path className="node-icon" d="M14 17h32v20H14zM14 18l16 12 16-12" /></g><text className="node-label" x="165" y="210">INITIAL ACCESS</text><text className="node-detail" x="165" y="234">Finance workstation</text>
      <g transform="translate(395 175)"><circle className="node-plate" cx="30" cy="25" r="29" /><circle className="node-icon" cx="30" cy="18" r="7" /><path className="node-icon" d="M17 40c3-10 23-10 26 0" /></g><text className="node-label" x="425" y="135" textAnchor="middle">CREDENTIAL ACCESS</text><text className="node-detail" x="425" y="159" textAnchor="middle">SVC-BACKUP</text>
      <g transform="translate(735 245)"><circle className="node-plate" cx="30" cy="25" r="29" /><path className="node-icon" d="M30 39V15M20 25l10-10 10 10M17 40h26" /></g><text className="node-label" x="705" y="165" textAnchor="end">PRIVILEGE ESCALATION</text><text className="node-detail" x="705" y="189" textAnchor="end">Tier-0 control</text>
      <g transform="translate(395 385)"><circle className="node-plate" cx="30" cy="25" r="29" /><circle className="node-icon" cx="30" cy="25" r="12" /><path className="node-icon" d="M30 7v8M30 35v8M12 25h8M40 25h8" /></g><text className="node-label" x="365" y="360" textAnchor="end">DISCOVERY</text><text className="node-detail" x="365" y="384" textAnchor="end">Network enumeration</text>
      <g transform="translate(735 385)"><circle className="node-plate" cx="30" cy="25" r="29" /><path className="node-icon" d="M19 17l22 8-22 8M20 38h22" /></g><text className="node-label" x="835" y="360">LATERAL MOVEMENT</text><text className="node-detail" x="835" y="384">Admin share route</text>
      <g transform="translate(475 475)"><circle className="node-plate" cx="30" cy="25" r="29" /><path className="node-icon" d="M30 12v24M20 26l10 10 10-10M16 40h28" /></g><text className="node-label" x="505" y="555" textAnchor="middle">EXPOSURE CONFIRMED</text><text className="node-detail" x="505" y="579" textAnchor="middle">Directory control</text>
      <g transform="translate(755 485)"><rect className="legend-box" width="202" height="108" /><line className="legend-observed" x1="17" x2="42" y1="25" y2="25" /><text className="legend-text" x="56" y="30">OBSERVED</text><line className="legend-inferred" x1="17" x2="42" y1="57" y2="57" /><text className="legend-text" x="56" y="62">INFERRED</text><circle className="node-plate" cx="23" cy="85" r="10" /><text className="legend-text" x="56" y="90">EVIDENCE POINT</text></g>
    </svg>
  </div>;
}
        ...
        <section className="hero section-shell">
          ...
          <div className="hero-panel" aria-label="RedPath evidence board attack path diagram">
            <div className="case-board">
              ...
              <ReferenceBoard />
              <div className="case-board-route"><svg className="board-svg" viewBox="0 0 1000 600" preserveAspectRatio="none" role="img" aria-label="Six-stage synthetic attack path from workstation to directory control"><path className="attack-route" d="M120 340 H305 L375 195 H650 L800 335 V425 H600 V505" /><path className="inferred-route" d="M305 340 L375 430 H800" /><g className="hot"><polygon className="glyph" points="100,315 140,315 160,340 140,365 100,365 80,340" /><text className="index" x="120" y="341">01</text><text className="kind" x="180" y="307">INITIAL ACCESS</text><text className="node-name" x="180" y="337">WS-21</text><text className="node-note" x="180" y="360">Finance workstation</text></g><g><polygon className="glyph" points="355,170 395,170 415,195 395,220 355,220 335,195" /><text className="index" x="375" y="196">02</text><text className="kind" x="435" y="160">CREDENTIAL ACCESS</text><text className="node-name" x="435" y="190">SVC-BACKUP</text><text className="node-note" x="435" y="213">Recoverable ticket</text></g><g className="hot"><polygon className="glyph" points="630,115 670,115 690,140 670,165 630,165 610,140" /><text className="index" x="650" y="141">03</text><text className="kind" x="710" y="105">PRIVILEGE ESCALATION</text><text className="node-name" x="710" y="135">TIER-0</text><text className="node-note" x="710" y="158">Delegated control</text></g><g><polygon className="glyph" points="355,405 395,405 415,430 395,455 355,455 335,430" /><text className="index" x="375" y="431">04</text><text className="kind" x="435" y="395">DISCOVERY</text><text className="node-name" x="435" y="425">DIRECTORY MAP</text><text className="node-note" x="435" y="448">Inferred relationship</text></g><g><polygon className="glyph" points="780,310 820,310 840,335 820,360 780,360 760,335" /><text className="index" x="800" y="336">05</text><text className="kind" x="740" y="382" textAnchor="end">LATERAL MOVEMENT</text><text className="node-name" x="740" y="412" textAnchor="end">APP-01</text><text className="node-note" x="740" y="435" textAnchor="end">Admin share route</text></g><g className="hot"><polygon className="glyph" points="580,480 620,480 640,505 620,530 580,530 560,505" /><text className="index" x="600" y="506">06</text><text className="kind" x="660" y="475">EXPOSURE CONFIRMED</text><text className="node-name" x="660" y="505">DC-01</text><text className="node-note" x="660" y="528">Directory control</text></g><g transform="translate(775 465)"><rect className="legend-panel" width="195" height="112" /><line className="legend-observed" x1="16" x2="39" y1="25" y2="25" /><text className="legend-text" x="52" y="30">OBSERVED</text><line className="legend-inferred" x1="16" x2="39" y1="57" y2="57" /><text className="legend-text" x="52" y="62">INFERRED</text><polygon className="legend-point" points="17,75 29,75 35,84 29,93 17,93 11,84" /><text className="legend-text" x="52" y="89">EVIDENCE POINT</text></g></svg></div>
            </div>
          </div>
