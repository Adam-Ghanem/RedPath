...
function ReferenceBoard() {
  return <div className="reference-board" role="img" aria-label="Observed RedPath exposure route through synthetic Active Directory evidence">
    <svg viewBox="0 0 1000 620" preserveAspectRatio="none"><path className="observed" d="M125 250 H290 L420 200 H635 L765 270" /><path className="observed" d="M765 270 V410 H650 L505 500" /><path className="inferred" d="M125 250 L240 410 H420" /><path className="inferred" d="M125 250 L125 430 L505 500" />
      <g transform="translate(105 225)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><path className="node-icon" d="M14 17h32v20H14zM14 18l16 12 16-12" /></g><text className="node-label" x="135" y="190">INITIAL ACCESS</text><text className="node-detail" x="135" y="214">Finance workstation</text>
      <g transform="translate(395 175)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><circle className="node-icon" cx="30" cy="18" r="7" /><path className="node-icon" d="M17 40c3-10 23-10 26 0" /></g><text className="node-label" x="425" y="135">CREDENTIAL ACCESS</text><text className="node-detail" x="425" y="159">SVC-BACKUP</text>
      <g transform="translate(735 245)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><circle className="node-icon" cx="23" cy="24" r="7" /><path className="node-icon" d="M28 29l14 14M37 38l5-5M34 42l5-5" /></g><text className="node-label" x="705" y="215" textAnchor="end">PRIVILEGE ESCALATION</text><text className="node-detail" x="705" y="239" textAnchor="end">Tier-0 control</text>
      <g transform="translate(395 385)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><circle className="node-icon" cx="30" cy="25" r="12" /><path className="node-icon" d="M30 7v8M30 35v8M12 25h8M40 25h8" /></g><text className="node-label" x="365" y="375" textAnchor="end">DISCOVERY</text><text className="node-detail" x="365" y="399" textAnchor="end">Network enumeration</text>
      <g transform="translate(735 385)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><path className="node-icon" d="M19 17l22 8-22 8M20 38h22" /></g><text className="node-label" x="835" y="375">LATERAL MOVEMENT</text><text className="node-detail" x="835" y="399">Admin share route</text>
      <g transform="translate(475 475)"><polygon className="node-plate" points="0,25 15,0 45,0 60,25 45,50 15,50" /><path className="node-icon" d="M30 12v24M20 26l10 10 10-10M16 40h28" /></g><text className="node-label" x="505" y="555" textAnchor="middle">EXPOSURE CONFIRMED</text><text className="node-detail" x="505" y="579" textAnchor="middle">Directory control</text>
      <g transform="translate(755 485)"><rect className="legend-box" width="202" height="108" /><line className="legend-observed" x1="17" x2="42" y1="25" y2="25" /><text className="legend-text" x="56" y="30">OBSERVED</text><line className="legend-inferred" x1="17" x2="42" y1="57" y2="57" /><text className="legend-text" x="56" y="62">INFERRED</text><polygon className="node-plate" points="17,76 29,76 35,85 29,94 17,94 11,85" /><text className="legend-text" x="56" y="90">EVIDENCE POINT</text></g>
    </svg>
  </div>;
}
